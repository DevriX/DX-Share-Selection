...
<div class="wrap main-wrap">
					...
					<section class="section optional-settings">
						...
						<p class="p-with-small">
							...
							<span class="inner-span">
								...
								<small class="smallText"><?php echo wp_kses_data( __( 'Selected texts are truncated when <code>%ts</code> is used in the URL', 'dxss' ) ); ?></small>
							</span>
						</p>
						<p class="p-with-small">
	...
	<div class="modal-overlay">
		...
		<div class="modal helpWindow">
			...
			<div class="wrap">
				...
				<ol>
					<li><?php echo wp_kses_data( __( 'Use <code>%s</code> in the Share/Search URL to use the selected text.', 'dxss' ) ); ?></li>
					<li><?php echo wp_kses_data( __( 'Use <code>%ts</code> in the URL to use the truncated selected text (115 characters. Used in Twitter URL).', 'dxss' ) ); ?></li>
	...
	<?php if ( file_exists( 'sidebar-right-help.php' ) && file_exists( 'sidebar-right-plugins.php' ) ) : ?>
		<div class="sidebars">
